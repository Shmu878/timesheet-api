...
func (a *adapterImpl) Init(cfg *config.Adapter) error {
	...
	if !a.client.AwaitReadiness(ReadyTimeout) {
		return kitGrpc.ErrGrpcSrvNotReady("timeshee")
	}
...
func (a *adapterImpl) SearchTimesheet(ctx context.Context, rq *pb.SearchTimesheetRequest) (*pb.SearchTimesheetResponse, error) {
...
func (a *adapterImpl) SearchEvents(ctx context.Context, rq *pb.TimesheetIdRequest) (*pb.SearchResponse, error) {
